...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Boutique chartered accountancy firm offering audit, taxation, advisory and compliance services for growing businesses." },
      { property: "og:title", content: "ABC & Associates — Chartered Accountants" },
      { property: "og:description", content: "Reliable financial guidance, audit and advisory for ambitious businesses." },
