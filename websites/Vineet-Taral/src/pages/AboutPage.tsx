...
const AboutPage = () => {
  ...
  return (
    <div>
      <PageHero title="About Vineet Taral & Associates" breadcrumb="About" image={pageData?.sections?.find((s: any) => s.type === 'hero')?.imageUrl || getImageUrl('/uploads/about-hero.jpg')} />
