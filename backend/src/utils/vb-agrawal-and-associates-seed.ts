          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'vbagrawal Management', description: 'Internal controls and rvbagrawal assessment' },
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'vbagrawal Management', description: 'Internal controls and fraud detection' },
