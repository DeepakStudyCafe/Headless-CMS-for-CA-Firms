...
import { API_URL, WEBSITE_SLUG, getPageData, getImageUrl } from '@/lib/api';
        ...
        <section className="section-padding">
          <div className="container-max mx-auto text-center">
            <ScrollReveal>
              ...
              <p className="text-body max-w-2xl mx-auto mb-12">{careerSection?.textContent?.benefitsDescription || 'We believe great work comes from great people in a great environment.'}</p>
            </ScrollReveal>
