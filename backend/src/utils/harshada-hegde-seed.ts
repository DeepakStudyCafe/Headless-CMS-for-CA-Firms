...
async function main() {
  console.log('🌱 Seeding Harshada Hegde & Associates...')

  // Upsert website
  const harshadaHegde = await prisma.website.upsert({
    where: { slug: 'harshada-hegde' },
    update: {
      name: 'Harshada Hegde & Associates',
      domain: 'https://harshadahegde.com/',
      logo: '/uploads/logo.svg',
      phone: '+91 9867228541, +91 2245186082',
      email: 'info@harshadahegde.com',
      address: '1013, The Epicenter, Off Eastern Freeway, Near Shivaji Chowk, Chembur, Mumbai - 400088.',
  ...
  console.log('✅ Harshada Hegde & Associates website created/updated')

  // Create pages (home, about, team, gallery)
  // Create or update Home page
  const existingHome = await prisma.page.findUnique({
    where: { websiteId_slug: { websiteId: harshadaHegde.id, slug: 'home' } },
  ...
  const homeSections = [
    ...
    },
    {
      ...
      textContent: {
        ...
        description: 'Harshada Hegde & Associates is a premier consulting firm dedicated to providing top-tier strategic advisory, financial management, and operational excellence solutions.',
    ...
    },
    {
      ...
      textContent: {
        ...
        description: 'Partner with Harshada Hegde & Associates for innovative solutions that drive real results.',
  ...
  if (existingHome) {
    ...
    await prisma.page.update({
      ...
      data: {
        title: 'Home - Harshada Hegde & Associates',
        status: 'PUBLISHED',
  ...
  const existingAbout = await prisma.page.findUnique({
    where: { websiteId_slug: { websiteId: harshadaHegde.id, slug: 'about' } },
    include: { sections: true },
  })
  ...
  const aboutSections = [
    {
      ...
      textContent: {
        heading: 'About Harshada Hegde & Associates',
    ...
    },
    {
      ...
      textContent: {
        ...
        description: 'With over two decades of experience, Harshada Hegde & Associates has been at the forefront of business innovation. We believe in creating lasting value for our clients through rigorous analysis and creative thinking.',
  ...
  if (existingAbout) {
    ...
    await prisma.page.update({
      ...
      data: {
        title: 'About Us - Harshada Hegde & Associates',
        status: 'PUBLISHED',
        publishedAt: new Date(),
  ...
  try {
    await prisma.page.create({
      data: {
        websiteId: harshadaHegde.id,
        slug: 'team',
        title: 'Our Team - Harshada Hegde & Associates',
        status: 'PUBLISHED',
        publishedAt: new Date(),
        sections: {
          create: [
  ...
  try {
    await prisma.page.create({
      data: {
        websiteId: harshadaHegde.id,
        slug: 'gallery',
        title: 'Gallery - Harshada Hegde & Associates',
        status: 'PUBLISHED',
        publishedAt: new Date(),
        sections: {
          create: [
            {
              ...
              textContent: {
                heading: 'Inside Harshada Hegde & Associates',
  ...
  const pages = [
    ...
    { slug: 'career', title: 'Careers', heading: 'Join Harshada Hegde & Associates', subheading: 'Build a meaningful career in consulting.' },
    ...
    try {
      await prisma.page.create({
        data: {
          websiteId: harshadaHegde.id,
          slug: page.slug,
          title: `${page.title} - Harshada Hegde & Associates`,
          status: 'PUBLISHED',
          publishedAt: new Date(),
          sections: {
            create: [
              ...
              },
              {
                ...
                textContent: {
                  ...
                  description: `Explore ${page.title.toLowerCase()} at Harshada Hegde & Associates and see how we make a difference.`,
  ...
  const services = [
    {
      slug: 'bookkeeping',
      title: 'Corporate Bookkeeping - Harshada Hegde & Associates',
    ...
    {
      slug: 'gst-filing',
      title: 'GST Compliance - Harshada Hegde & Associates',
    ...
    {
      slug: 'payroll',
      title: 'Payroll Management - Harshada Hegde & Associates',
    ...
    {
      slug: 'tax-planning',
      title: 'Tax Planning & Advisory - Harshada Hegde & Associates',
    ...
    },
    {
      ...
      title: 'Business Setup Services - Harshada Hegde & Associates',
    ...
    {
      slug: 'compliance',
      title: 'Corporate Compliance - Harshada Hegde & Associates',
    ...
    {
      slug: 'audit-services',
      title: 'Audit & Assurance - Harshada Hegde & Associates',
    ...
    },
    {
      ...
      title: 'Corporate Finance Advisory - Harshada Hegde & Associates',
    ...
    try {
      ...
      if (err?.code === 'P2002') {
        ...
        const page = await prisma.page.findUnique({
          where: { websiteId_slug: { websiteId: harshadaHegde.id, slug: service.slug } }
        });
        if (page) {
  ...
  console.log('✅ Harshada Hegde & Associates seed completed.')
}
