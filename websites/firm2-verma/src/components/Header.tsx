                    ...
                    <AnimatePresence>
                      {servicesOpen && (
                        <motion.div
                          ...
                          className="absolute top-full left-0 mt-2 w-56 bg-white rounded-sm shadow-lg border border-gray-100 py-2 z-50"
                        >
                          {serviceDropdown.map((service) => (
                            <Link
                              key={service.name}
                              href={service.href}
                              className="block px-4 py-2 text-sm font-light text-gray-600 hover:bg-gray-50 hover:text-black transition-colors"
                            >
                              {service.name}
                            </Link>
                          ))}
