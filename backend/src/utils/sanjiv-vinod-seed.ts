...
async function main() {
  ...
  await prisma.section.deleteMany({ where: { page: { website: { slug: 'sanjiv-vinod-and-associates' } } } });
  await prisma.page.deleteMany({ where: { website: { slug: 'sanjiv-vinod-and-associates' } } });

  // Create admin user
  const adminPassword = await bcrypt.hash('abhinandan@svaca', 10)
  const admin = await prisma.user.upsert({
    where: { email: 'admin@cafirm.com' },
    update: {},
    create: {
      name: 'Admin User',
      email: 'abhinandan@svaca.com',
  ...
  // ============================================================
  // WEBSITE 1: Sanjiv Vinod & Associates (Professional Blue Theme)
  // ============================================================
  const sv = await prisma.website.upsert({
    ...
    update: {
      ...
      address: 'SCO 15 Opp The British Coed School Lower Mall Road Patiala Punjab 147001',
  ...
  console.log('✅ Sanjiv Vinod & Associates website created')
  ...
  await prisma.page.create({
    data: {
      websiteId: sv.id,
      slug: 'home',
      title: 'Home - Sanjiv Vinod & Associates',
      status: 'PUBLISHED',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'With over 1 years of experience, Sanjiv Vinod & Associates provides top-tier audit, taxation, and corporate advisory services to businesses across industries.',
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'Risk Management', description: 'Internal controls and rkpv assessment' },
  ...
  await prisma.page.create({
    data: {
      websiteId: sv.id,
      slug: 'about',
      title: 'About Us - Sanjiv Vinod & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            textContent: {
              heading: 'About Sanjiv Vinod & Associates',
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'Founded by Sanjiv Vinod, our firm has grown from a small practice to one of the most respected accounting firms in the region. We specialize in serving corporate clients with complex audit and taxation needs.',
  ...
  await prisma.page.create({
    data: {
      websiteId: sv.id,
      slug: 'team',
      title: 'Our Team - Sanjiv Vinod & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                { name: 'Sanjiv Vinod', role: 'Managing Partner', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400', description: 'FCA, 30+ years experience' },
  ...
  await prisma.page.create({
    data: {
      websiteId: sv.id,
      slug: 'services',
      title: 'Our Services - Sanjiv Vinod & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: sv.id,
      slug: 'gallery',
      title: 'Gallery - Sanjiv Vinod & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: sv.id,
      slug: 'contact',
      title: 'Contact Us - Sanjiv Vinod & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3443.864144467861!2d76.38825527502148!3d30.32638190515855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391028e65962e597%3A0x2287b9b2c4474b!2z4pyFIPCdl6bwnZeu8J2Xu_Cdl7fwnZe28J2YgyDwnZep8J2XtvCdl7vwnZe88J2XsSAmIPCdl5TwnZiA8J2YgPCdl7zwnZew8J2XtvCdl67wnZiB8J2XsvCdmIAgLSBCZXN0IENBIGluIFBhdGlhbGE!5e0!3m2!1sen!2sin!4v1782280837778!5m2!1sen!2sin',
            },
          },
          {
            type: 'contact-form',
  ...
  const svServices = [
    {
      slug: 'audit-services',
      title: 'Audit Services - Sanjiv Vinod & Associates',
    ...
    },
    {
      ...
      title: 'Taxation Services - Sanjiv Vinod & Associates',
    ...
    },
    {
      ...
      title: 'Corporate Services - Sanjiv Vinod & Associates',
    ...
    {
      slug: 'bookkeeping',
      title: 'Bookkeeping Services - Sanjiv Vinod & Associates',
    ...
    {
      slug: 'gst-filing',
      title: 'GST Filing Services - Sanjiv Vinod & Associates',
    ...
    {
      slug: 'payroll',
      title: 'Payroll Management - Sanjiv Vinod & Associates',
    ...
    {
      slug: 'tax-planning',
      title: 'Tax Planning & Advisory - Sanjiv Vinod & Associates',
    ...
    },
    {
      ...
      title: 'Company Formation - Sanjiv Vinod & Associates',
    ...
    {
      slug: 'compliance',
      title: 'Regulatory Compliance - Sanjiv Vinod & Associates',
    ...
    },
    {
      ...
      title: 'Financial Advisory - Sanjiv Vinod & Associates',
  ...
  console.log('  ✅ Sanjiv Vinod & Associates: 10 pages created')
