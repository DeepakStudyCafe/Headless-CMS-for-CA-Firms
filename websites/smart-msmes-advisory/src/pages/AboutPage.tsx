...
const AboutPage = () => {
  ...
  return (
    <div>
      <PageHero title="About Smart Msmes Advisory" breadcrumb="About" image={pageData?.sections?.find((s: any) => s.type === 'hero')?.imageUrl || getImageUrl('/uploads/about-hero.jpg')} />
  ...
  Smart Msmes Advisory is a trusted FEMA & Indirect Tax Expert firm with a legacy of excellence spanning nearly two decades. We blend deep regulatory expertise with modern strategies to deliver reliable and result-driven financial solutions.
</p>
