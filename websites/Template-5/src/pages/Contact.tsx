    ...
    <div className="min-h-screen bg-paper flex flex-col">
      ...
      <section className="relative bg-charcoal py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
          ...
          >
            {heroSection?.textContent?.subheading || "We would love to hear from you. Let us start a conversation about your financial future."}
          </motion.p>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div
              ...
              className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-gold/10"
            >
              <Form {...form}>
      ...
      <section className="bg-charcoal py-16 px-6 lg:px-8 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[
            ...
            { icon: MapPin, label: "Visit Us", value: "Lower Parel, Mumbai" },
          ].map((item, i) => (
            <motion.div
              key={item.label}
            ...
            >
              ...
              <span className="font-sans text-white/70 text-sm">{item.value}</span>
            </motion.div>
          ))}
        </div>
      </section>
