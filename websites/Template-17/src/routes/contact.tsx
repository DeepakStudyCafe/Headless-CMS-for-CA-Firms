                ...
                <div className="rounded-2xl border border-border bg-background p-8 shadow-sm md:p-10">
                  {submitted ? (
                    ...
                    <form
                      ...
                      onSubmit={async (e) => {
                        ...
                        try {
                          ...
                          const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/public/forms/template-17`, {
                            method: 'POST',
                    ...
                    >
                      ...
                      <div className="grid gap-6 sm:grid-cols-2">
                        <Field label="Phone Number"><Input name="phone" required type="tel" placeholder="+91 98765 43210" className="bg-surface" /></Field>
                        <Field label="Subject"><Input name="subject" required placeholder="How can we help?" className="bg-surface" /></Field>
                      </div>
                      <Field label="Message">
                        <Textarea name="message" rows={5} required placeholder="Tell us about your requirements..." className="resize-none bg-surface" />
                      </Field>
