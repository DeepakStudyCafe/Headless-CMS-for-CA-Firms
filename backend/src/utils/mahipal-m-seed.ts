...
async function main() {
  console.log('Seeding Mahipal M Singh & Associates website data...')

  const website = await prisma.website.upsert({
    where: { slug: 'mahipal-m-singh-and-associates' },
    update: {
      name: 'Mahipal M Singh & Associates',
      domain: 'https://camahipal.in/',
      logo: 'https://api.digitechai.in/uploads/logo.png', // Or fallback if empty
      phone: CONTACT_INFO.phone,
      email: CONTACT_INFO.email,
      address: CONTACT_INFO.address,
      workingHours: '09:30 AM to 18:00 PM',
      isActive: true,
      isAdminEnabled: true,
      themeConfig: {
        primaryColor: '#0f172a',
        ...
        footerContent: {
           description: "Mahipal M Singh & Associates partners with businesses and individuals to deliver clear, compliant and growth-focused financial services — from audit and taxation to advisory and business compliance.",
           copyright: "© 2026 Mahipal M Singh & Associates. All rights reserved.",
        }
      },
    },
    create: {
      name: 'Mahipal M Singh & Associates',
      slug: 'mahipal-m-singh-and-associates',
      domain: 'https://camahipal.in/',
  ...
  console.log('✅ Mahipal M Singh & Associates website created')
  ...
  await prisma.page.create({
    data: {
      ...
      slug: 'home',
      title: 'Home - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'Mahipal M Singh & Associates is a full-service Chartered Accountancy firm based in India, serving private companies, startups, public enterprises and individuals. Our partners bring deep technical expertise across audit, tax and advisory — combined with a personal commitment to every client we serve.',
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'about',
      title: 'About Us - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            textContent: {
              heading: 'About Mahipal M Singh & Associates',
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'services',
      title: 'Services - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  for (const svc of t5services) {
    ...
    await prisma.page.create({
      data: {
        websiteId: website.id,
        slug: svc.slug,
        title: `${svc.title} - Mahipal M Singh & Associates`,
        status: 'PUBLISHED',
        publishedAt: new Date(),
        sections: {
          create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'team',
      title: 'Our Professionals - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'gallery',
      title: 'Our Gallery - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'contact',
      title: 'Contact Us - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'career',
      title: 'Join Our Team - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'query',
      title: 'Submit a Query - Mahipal M Singh & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  console.log('  ✅ Mahipal M Singh & Associates: Pages created')

  // ─── Seed SiteAdmin credentials for /admin route ─────────────────────────────
  const bcrypt = await import('bcryptjs')
  const siteAdminEmail = 'admin@camahipal.in'
  const siteAdminPassword = 'Admin@1234'
  ...
  console.log(`  ✅ Mahipal M Singh & Associates: SiteAdmin credentials set — ${siteAdminEmail} / ${siteAdminPassword}`)

  console.log('\n🎉 Database seed for Mahipal M Singh & Associates completed successfully!')
}

main()
  .catch((e) => {
    console.error('Error seeding Mahipal M Singh & Associates data:', e)
    process.exit(1)
  })
  .finally(async () => {
