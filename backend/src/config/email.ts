...
const WEBSITE_EMAILS = {
  'firm1-sharma': process.env.FIRM1_EMAIL,
  'firm2-verma': process.env.FIRM2_EMAIL,
  'firm3-gupta': process.env.FIRM3_EMAIL,
  'firm4-kapoor': process.env.FIRM4_EMAIL,
  'firm5-singh': process.env.FIRM5_EMAIL,
  'firm6-patel': process.env.FIRM6_EMAIL,
  'template-4': process.env.TEMPLATE_4_EMAIL,
  'showcase-website': process.env.SHOWCASE_EMAIL,
  'abhishekrajaram': process.env.ABHISHEKRAJARAM_EMAIL,
  'monikas': process.env.MONIKAS_EMAIL,
  's-b-bhavi': process.env.SB_BHAVI_EMAIL,
  'agarwal-financial-consultancy': process.env.AGARWAL_EMAIL,
  'vineet-taral': process.env.VINEET_EMAIL,
  'vineet-taral-and-associates': process.env.VINEET_EMAIL,
  'isk-and-co': process.env.ISK_AND_CO_EMAIL,
  'vb-agrawal-and-associates': process.env.VB_AGRAWAL_EMAIL,
  'k-s-anithasree-and-associates': process.env.ANITHASREE_EMAIL,
  'burlagadda-and-associates': process.env.BURLAGADDA_EMAIL,
  'firm1-isk': process.env.ISK_AND_CO_EMAIL,
  'r-mugunthan': process.env.RMUGUNTHAN_EMAIL,
  'abhinav-j-and-company': process.env.ABHINAVJ_EMAIL,
  'a-arun-ganjewar-and-co': process.env.ARUN_EMAIL,
  'anagam-and-co': process.env.ANAGAM_EMAIL,
  'ca-mohan-c': process.env.MOHAN_C_EMAIL,
  'nipun-panchamiya-and-associates': process.env.NIPUN_EMAIL,
  'd-u-and-associates': process.env.DU_ASSOCIATES_EMAIL,
  'satyug-corporate-consultancy': process.env.SATYUG_EMAIL,
  'ajoy-goyal-and-co': process.env.AJOY_GOYAL_EMAIL,
  'smart-msmes-advisory': process.env.SMART_MSMES_EMAIL,
  'harshada-hegde': process.env.HARSHADA_HEGDE_EMAIL,
  'Harshada-Hegde': process.env.HARSHADA_HEGDE_EMAIL,
  'rupesh-gunjal': process.env.RUPESH_GUNJAL_EMAIL,
  'Rupesh-Gunjal': process.env.RUPESH_GUNJAL_EMAIL,
  'tally-my-tax': process.env.TALLY_MY_TAX_EMAIL,
  'delta-core-wealth': process.env.DELTA_EMAIL,
  'kpv-and-associates': process.env.KPV_EMAIL,
  'krishan-garg-and-co': process.env.KRISHAN_GARG_EMAIL,
  'mpkr-and-co-llp': process.env.MPKR_EMAIL,
  'mahipal-m-singh-and-associates': process.env.MAHIPAL_EMAIL,
  'sanjiv-vinod-and-associates': process.env.SANJIV_VINOD_EMAIL,
  'ketki-dagha-and-associates': process.env.KETKI_DAGHA_EMAIL,
  'david-and-co': process.env.DAVID_AND_CO_EMAIL,
  'may-and-associates': process.env.MAY_AND_ASSOCIATES_EMAIL
};
...
const WEBSITE_NAMES = {
  ...
  'delta-core-wealth': 'DeltaCore Wealth',
  ...
  'may-and-associates':'May & Associates'
};
