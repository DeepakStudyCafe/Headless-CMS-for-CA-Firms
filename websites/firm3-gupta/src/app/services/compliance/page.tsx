...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getPageData('compliance')
  return {
    title: page?.title || 'Compliance Services - Gupta Tax Advisors',
    description: 'Comprehensive regulatory compliance services'
  }
}
