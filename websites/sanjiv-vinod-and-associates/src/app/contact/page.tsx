      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Map */}
            <motion.div 
              className="h-100 bg-gray-200 rounded-lg overflow-hidden"
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.7 }}
            >
              <iframe
                src={cc.mapUrl || 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3443.864144467861!2d76.38825527502148!3d30.32638190515855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391028e65962e597%3A0x2287b9b2c4474b!2z4pyFIPCdl6bwnZeu8J2Xu_Cdl7fwnZe28J2YgyDwnZep8J2XtvCdl7vwnZe88J2XsSAmIPCdl5TwnZiA8J2YgPCdl7zwnZew8J2XtvCdl67wnZiB8J2XsvCdmIAgLSBCZXN0IENBIGluIFBhdGlhbGE!5e0!3m2!1sen!2sin!4v1782280837778!5m2!1sen!2sin'}
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
