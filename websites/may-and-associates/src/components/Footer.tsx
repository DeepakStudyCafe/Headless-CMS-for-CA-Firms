    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
          ...
          <div className="mb-8 md:mb-0 md:w-1/3 shrink-0">
            <div className="flex items-center space-x-3 mb-4 shrink-0 overflow-hidden">
              <Image
                ...
                unoptimized
              />
              <h3 className="text-2xl font-bold p-0 tracking-[0.03em]">{websiteData?.name || 'MAY & Associates'}</h3>
            </div>
          ...
          <div className="flex flex-1 flex-col md:flex-row md:justify-between gap-8 min-w-0">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                {/* <Link href="/services/compliance" className="block text-gray-400 hover:text-white">Compliance</Link>
                <Link href="/services/audit-services" className="block text-gray-400 hover:text-white">Audit Services</Link>
                <Link href="/services/financial-advisory" className="block text-gray-400 hover:text-white">Financial Advisory</Link> */}
              </div>
            </div>
            <div>
              ...
              {websiteData?.address && (
                <p className="text-gray-400 mb-2 break-words max-w-xs md:max-w-sm lg:max-w-md">Address: {websiteData.address}</p>                
              )}
              <div className="flex gap-4 mt-4">
                <a href={fc.facebook || 'https://www.facebook.com'} target="_blank" rel="noopener" aria-label="Facebook" className="rounded-full bg-white/10 hover:bg-blue-600 transition-colors w-10 h-10 flex items-center justify-center">
        ...
        <div className="border-t border-gray-800 mt-8 pt-2 flex flex-row justify-between items-center text-gray-400">
          <div>
            {fc.copyright || '\u00a9 2026 MAY & Associates. All rights reserved.'}
          </div>
          <div>
            Powered By{' '}
            <a href="https://webcafe.co.in/" target="_blank" rel="noopener" className="hover:text-white hover:underline no-underline"> Webcafe a Product of Studycafe Pvt Ltd.</a>
          </div>
        </div>
      </div>
    </footer>
