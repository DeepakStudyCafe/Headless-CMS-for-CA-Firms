...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-card/95 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
      ...
      <nav className="container-wide mx-auto px-4 flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="flex items-center gap-2">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden bg-transparent flex items-center justify-center p-1">
            <img
