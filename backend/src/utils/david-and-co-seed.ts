...
async function main() {
  ...
  await prisma.section.deleteMany({ where: { page: { website: { slug: 'david-and-co' } } } });
  await prisma.page.deleteMany({ where: { website: { slug: 'david-and-co' } } });
  ...
  // ============================================================
  // WEBSITE 1: David & Co (Professional Blue Theme)
  // ============================================================
  const davidWebsite = await prisma.website.upsert({
    where: { slug: 'david-and-co' },
    update: {
      name: 'David & Co',
      domain: 'https://davidandco.in/',
      logo: '/uploads/logo.svg',
      phone: '+91 9894145518',
      email: 'contact@davidandco.in',
      address: '1c/2c/1, Krishnarajapuram 1st street, Thoothukudi - 628002',
  ...
  console.log('✅ David & Co website created')

  // davidWebsite Pages
  await prisma.page.create({
    data: {
      websiteId: davidWebsite.id,
      slug: 'home',
      title: 'Home - David & Co',
      status: 'PUBLISHED',
        ...
        create: [
          {
            ...
            textContent: {
              heading: 'Trusted Chartered Accountants Since 2023',
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'With over 3 years of experience, David & Co Chartered Accountants provides top-tier audit, taxation, and corporate advisory services to businesses across industries.',
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'David & Co Management', description: 'Internal controls and David & Co assessment' },
        ...
        create: [
          {
            ...
            textContent: {
              heading: 'About David & Co',
              subheading: 'Building trust through excellence in accounting since 2023',
            },
          },
          {
            type: 'text-image',
            ...
            textContent: {
              ...
              description: 'Founded by CA David, our firm has grown from a small practice to one of the most respected accounting firms in the region. We specialize in serving corporate clients with complex audit and taxation needs.',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                { name: 'CA David', role: 'Proprietor', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400', description: 'CA, Direct & Indirect Taxes' },
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'David & Co Management', description: 'Internal controls and fraud detection' },
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d4648.1558699418665!2d78.14902153383744!3d8.82075792430489!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b03ef0047a3c103%3A0x31e8755379a76980!2sDavid%20%26%20Co%20Chartered%20Accountants!5e0!3m2!1sen!2sin!4v1783927777542!5m2!1sen!2sin',
  ...
  // davidWebsite Service Pages
  const davidWebsiteServices = [
    {
      slug: 'audit-services',
      title: 'Audit Services - David & Co',
    ...
    },
    {
      ...
      title: 'Taxation Services - David & Co',
    ...
    },
    {
      ...
      title: 'Corporate Services - David & Co',
    ...
    {
      slug: 'bookkeeping',
      title: 'Bookkeeping Services - David & Co',
    ...
    {
      slug: 'gst-filing',
      title: 'GST Filing Services - David & Co',
    ...
    {
      slug: 'payroll',
      title: 'Payroll Management - David & Co',
    ...
    {
      slug: 'tax-planning',
      title: 'Tax Planning & Advisory - David & Co',
    ...
    },
    {
      ...
      title: 'Company Formation - David & Co',
    ...
    {
      slug: 'compliance',
      title: 'Regulatory Compliance - David & Co',
    ...
    },
    {
      ...
      title: 'Financial Advisory - David & Co',
  ...
  for (const service of davidWebsiteServices) {
    await prisma.page.create({
      data: {
        websiteId: davidWebsite.id,
        slug: service.slug,
  ...
  console.log('  ✅ David & Co: 10 pages created')
