          ...
          <div className="container flex items-center justify-between h-20">
            <Link to="/" className="flex items-center gap-1 group">
              <img
                ...
                alt="Ketki Dagha and Associates. logo"
              ...
              <div className={`transition-colors ${scrolled ? "text-foreground" : "text-primary-foreground"}`}>
                <span className="font-heading font-bold text-lg leading-none block">Ketki Dagha and Associates.</span>
                <span className="text-[10px] uppercase tracking-[0.532em] opacity-70 font-medium">Chartered Accountants</span>
              </div>
            </Link>
