...
export const Route = createFileRoute("/team")({
  head: () => ({
    meta: [
      { title: "Our Team — Mahipal M Singh & Associates" },
      { name: "description", content: "Meet the partners and senior team at Mahipal M Singh & Associates — experienced Chartered Accountants serving clients across India." },
      { property: "og:title", content: "Our Team — Mahipal M Singh & Associates" },
      { property: "og:description", content: "Experienced Chartered Accountants and advisors leading Mahipal M Singh & Associates." },
    ],
  }),
  component: TeamPage,
});
                  ...
                  <div className="group overflow-hidden rounded-xl border border-border bg-background shadow-sm transition-transform duration-300 hover:-translate-y-1 hover:shadow-md hover:border-secondary">
                    <div className="relative aspect-square overflow-hidden bg-muted">
                      ...
                      <div className="absolute bottom-3 right-3 flex translate-y-3 gap-2 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                        ...
                        <a href={`mailto:${m.name.toLowerCase().replace(" ", ".")}camahipalyadav@gmail.com`} className="flex h-8 w-8 items-center justify-center rounded-full bg-secondary text-secondary-foreground">
