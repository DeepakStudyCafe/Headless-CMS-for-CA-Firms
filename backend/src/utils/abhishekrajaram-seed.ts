...
async function main() {
  console.log('Seeding Abhishekrajaram (Abhishek Raja Ram & Co.) website data...')
    ...
    update: {
      ...
      themeConfig: {
        ...
        footerContent: {
          ...
          copyright: "© 2026 Abhishek Raja Ram & Co. Chartered Accountants. All rights reserved.",
          facebook: "",
          twitter: "",
          linkedin: "",
          instagram: "",
  ...
  console.log('✅ Abhishek Raja Ram & Co. (Abhishekrajaram) website created')
  ...
  await prisma.page.create({
    data: {
      ...
      slug: 'home',
      title: 'Home - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
        ...
        create: [
          {
            ...
            textContent: {
              ...
              subheading: 'Abhishek Raja Ram & Co. — trusted by 2,500+ businesses for taxation, compliance, and strategic financial advisory since 1995.',
          ...
          },
          {
            ...
            textContent: {
              heading: 'Nearly Three Decades of Financial Excellence',
              description: 'Founded in 1995, Abhishek Raja Ram & Co. has grown from a small practice to one of India\'s most respected chartered accountancy firms. We combine deep expertise with innovative solutions to help businesses navigate complex financial landscapes.',
              stats: STATS,
            },
          },
          {
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'about',
      title: 'About Us - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            textContent: {
              heading: 'About Abhishek Raja Ram & Co.',
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'services',
      title: 'Services - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  for (const svc of svcList) {
    ...
    await prisma.page.create({
      data: {
        websiteId: website.id,
        slug: svc.slug,
        title: `${svc.title} - Abhishek Raja Ram & Co.`,
        status: 'PUBLISHED',
        publishedAt: new Date(),
        sections: {
          create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'team',
      title: 'Our Team - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'gallery',
      title: 'Gallery - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            order: 2,
            textContent: {
              heading: 'Inside Abhishek Raja Ram & Co.',
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'contact',
      title: 'Contact Us - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'career',
      title: 'Careers - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            imageUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600',
            textContent: {
              heading: 'Grow With Abhishek Raja Ram & Co.',
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'query',
      title: 'Submit a Query - Abhishek Raja Ram & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  console.log('  ✅ Abhishekrajaram: Pages created')
  ...
  console.log(`  ✅ Abhishekrajaram: SiteAdmin credentials set — ${siteAdminEmail} / ${siteAdminPassword}`)

  console.log('\n🎉 Database seed for Abhishekrajaram completed successfully!')
}

main()
  .catch((e) => {
    console.error('Error seeding Abhishekrajaram data:', e)
    process.exit(1)
  })
  .finally(async () => {
