...
async function main() {
  console.log('Starting seed process for Smart Msmes Advisory...');

  try {
    await prisma.$transaction(async (tx) => {
      // Find existing website or create
      let website = await tx.website.findUnique({
        where: { slug: 'smart-msmes-advisory' }
      });
      ...
      if (!website) {
        website = await tx.website.create({
          data: {
            ...
            phone: '8967632836',
            email: 'info@smartmsmes.com',
            address: 'Rama Rao Niwas, Taljholi (Midnapur Scan Centre Gali behind Curry Room), Kharagpur, West Midnapur, West Bengal, Pin-721301',
            workingHours: '10 am to 6 pm',
            slug: 'smart-msmes-advisory',
            isActive: true,
          }
        });
        console.log('Created website: Smart Msmes Advisory');
      } else {
        console.log('Website Smart Msmes Advisory already exists, updating details...');
        await tx.website.update({ where: { id: website.id }, data: { phone: '8967632836', email: 'info@smartmsmes.com', address: 'Rama Rao Niwas, Taljholi (Midnapur Scan Centre Gali behind Curry Room), Kharagpur, West Midnapur, West Bengal, Pin-721301', workingHours: '10 am to 6 pm' } });
      }

      // ─── Site Admin ────────────────────────────
      const siteAdminEmail = 'admin@smartmsmes.com';
      ...
      await (tx as any).siteAdmin.upsert({
        ...
        update: { email: siteAdminEmail, passwordHash: siteAdminHash },
        create: { websiteId: website.id, email: siteAdminEmail, passwordHash: siteAdminHash },
      });
      console.log('Upserted SiteAdmin for Smart Msmes Advisory');
            ...
            "items": [
              {
                "year": "2005",
                "title": "Founded",
                "desc": "Smart Msmes Advisory established in Mumbai."
              },
              {
                "year": "2010",
                "title": "Expansion",
      ...
      const contactSections: any[] = [
        {
          ...
          textContent: {
            items: [
              { icon: 'MapPin', label: 'Address', value: website.address },
              { icon: 'Phone', label: 'Phone', value: website.phone },
              { icon: 'Mail', label: 'Email', value: website.email },
              { icon: 'Clock', label: 'Hours', value: website.workingHours },
            ]
          }
        },
        {
          ...
          textContent: {
            ...
            subheading: 'Have a question or want to discuss how we can help your business? Fill out the form and our team will get back to you within 24 hours.'
          }
        }
      ];
      ...
      const gallerySections = [

        {
          ...
          textContent: {
            "items": [
              {
                "src": "https://images.unsplash.com/photo-1454165833767-1316d314b609?auto=format&fit=crop&q=80&w=2070",
                "category": "Office",
                "title": "Board Room"
              },
              {
              ...
              {
                "src": "https://images.unsplash.com/photo-1507679799987-c7377ec486b6?auto=format&fit=crop&q=80&w=2070",
                "category": "Events",
              ...
              {
                "src": "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&q=80&w=2070",
                "category": "Events",
            ...
            "items": [
              {
                ...
                "text": "Smart Msmes Advisory transformed our financial operations. Their expertise in tax planning saved us significantly."
              },
              {
                "name": "Priya Mehta",
            ...
            "items": [
              {
                ...
                "image": "https://images.unsplash.com/photo-1454165833767-1316d314b609?auto=format&fit=crop&q=80&w=2070",
              ...
              },
              {
                ...
                "image": "https://images.unsplash.com/photo-1507679799987-c7377ec486b6?auto=format&fit=crop&q=80&w=2070",
                "socialLinks": { "linkedin": "#", "twitter": "#" }
              }
            ]
          }
      ...
      const newSections = [
        { pageSlug: 'about', type: 'about', textContent: { heading: 'Who We Are', description1: 'Founded in 2005, Smart Msmes Advisory has established itself as a premier FEMA & Indirect Tax Expert firm.', description2: 'We believe in building lasting relationships with our clients based on trust, integrity, and exceptional service quality.', missionHeading: 'Our Mission', missionText: 'To empower businesses with innovative financial solutions, ensuring compliance, growth, and long-term success through expert guidance and unwavering commitment.', visionHeading: 'Our Vision', visionText: 'To be the most trusted and innovative FEMA & Indirect Tax Expert firm globally, setting new benchmarks in financial excellence and regulatory compliance.' } },
    ...
    console.log('Successfully completed full deep seeding for Smart Msmes Advisory!');

  } catch (err) {
    console.error('Error seeding smart-msmes-advisory:', err);
  } finally {
