import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-3em5-vME.js";
import { L as Link } from "./router-BnnrsXTc.js";
import "node:events";
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[var(--color-navy)] text-white/80 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight flex h-9 items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+911234567890", className: "flex items-center gap-2 hover:text-white transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3.5 w-3.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "+91 12345 67890" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:contact@abcassociates.in", className: "flex items-center gap-2 hover:text-white transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-3.5 w-3.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "contact@abcassociates.in" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "LinkedIn", className: "hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "h-3.5 w-3.5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Twitter", className: "hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Twitter, { className: "h-3.5 w-3.5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Facebook", className: "hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { className: "h-3.5 w-3.5" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `bg-white border-b border-border transition-shadow ${scrolled ? "shadow-[0_4px_24px_oklch(0.2_0.04_260/0.06)]" : ""}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight flex h-[72px] items-center justify-between gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-8", children: NAV.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: item.to,
                className: "nav-underline text-sm font-medium text-[var(--color-foreground)] hover:text-[var(--color-accent)] transition-colors",
                activeProps: { "data-active": "true", className: "text-[var(--color-accent)]" },
                children: item.label
              },
              item.to
            )) }),
          ...
          open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden border-t border-border bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-tight py-4 flex flex-col gap-1", children: NAV.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: item.to,
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-[var(--color-navy)] text-white/80", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-16 grid gap-12 md:grid-cols-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4 space-y-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed text-white/70 max-w-sm", children: "ABC & Associates is a chartered accountancy firm delivering audit, tax, and advisory services to businesses building for the long term." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 pt-1", children: [Linkedin, Twitter, Facebook].map((Icon2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "#",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white text-sm font-semibold mb-4 tracking-wide uppercase", children: "Quick Links" }),
        ...
        ].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: i.to, className: "hover:text-white transition-colors", children: i.l }) }, i.to)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white text-sm font-semibold mb-4 tracking-wide uppercase", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 text-sm", children: ["Audit & Assurance", "Direct Taxation", "GST Advisory", "Corporate Compliance", "Business Advisory", "Outsourced Accounting"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "hover:text-white transition-colors cursor-default", children: s }, s)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white text-sm font-semibold mb-4 tracking-wide uppercase", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 mt-0.5 text-[var(--color-accent)] shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "4th Floor, Trade Centre,",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Bandra Kurla Complex, Mumbai 400051"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 mt-0.5 text-[var(--color-accent)] shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+91 12345 67890" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 mt-0.5 text-[var(--color-accent)] shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "contact@abcassociates.in" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/60", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-white", children: "Disclaimer" })
      ] })
    ] }) })
  ] });
}
...
function IntroBlock() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-[var(--color-background)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-bg pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-24 -left-24 h-72 w-72 rounded-full bg-[var(--color-accent)]/5 blur-2xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-[var(--color-navy)]/5 blur-2xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight relative pt-24 pb-28 lg:pt-32 lg:pb-36", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full border border-border bg-white px-3 py-1 text-xs font-medium text-[var(--color-navy-2)] shadow-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[var(--color-accent)]" }),
              "Chartered Accountants · Est. 2004"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-6 text-4xl sm:text-5xl lg:text-[56px] font-semibold leading-[1.05] tracking-tight", children: [
              "Clarity in numbers.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-accent)]", children: "Confidence in decisions." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto", children: "ABC & Associates is a full-service chartered accountancy firm partnering with founders, family businesses, and enterprises on audit, taxation, compliance, and advisory." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          ].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white px-5 py-5 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-[var(--color-primary)]", children: m.k }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: m.v })
          ] }, m.k))
        }
      )
    ] })
...
function FeatureStrip() {
  const items = [
    ...
    { icon: FileCheckCorner, title: "Accurate Compliance", desc: "Filings reviewed twice. Deadlines tracked. Zero surprises." },
    { icon: Clock3, title: "Fast Service", desc: "24-hour first response and clear delivery timelines." },
    { icon: UsersRound, title: "Sector Depth", desc: "Manufacturing, SaaS, retail, and professional services." }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-tight py-14 grid gap-px bg-border md:grid-cols-2 lg:grid-cols-4 rounded-xl overflow-hidden border border-border", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-11 w-11 items-center justify-center rounded-md bg-[var(--color-navy)]/5 text-[var(--color-navy-2)] group-hover:bg-[var(--color-accent)] group-hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(it.icon, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 text-base font-semibold text-[var(--color-primary)]", children: it.title }),
...
function AboutStats() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[var(--color-background)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-24 grid gap-14 lg:grid-cols-12 items-start", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 16 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-[0.18em] text-[var(--color-accent)] uppercase", children: "About the firm" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 text-3xl sm:text-4xl font-semibold leading-tight", children: [
            "A practice built on judgement,",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "not just process."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-4 text-[15px] text-muted-foreground leading-relaxed max-w-2xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Founded in 2004, ABC & Associates serves privately held companies, listed entities, and high-growth startups. Our work is grounded in technical rigour, regulatory awareness, and a steady, partner-led approach to every assignment." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We keep our teams small and senior. That means the person who scopes your engagement is the same person who signs off on it." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-8 space-y-3", children: points.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-[var(--color-foreground)]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-5 w-5 text-[var(--color-accent)] mt-0.5 shrink-0" }),
            p
          ] }, p)) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-5 space-y-4", children: stats.map((st, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground max-w-[55%]", children: st.l }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-semibold text-[var(--color-primary)] tabular-nums", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Counter, { to: st.v, suffix: st.s }) })
        ]
      },
      st.l
    )) })
...
function ServicesSplit() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-[0.18em] text-[var(--color-accent)] uppercase", children: "What we do" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-3xl sm:text-4xl font-semibold leading-tight", children: "A full practice. Delivered with focus." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-md", children: "Hover or tap any service to see what's included. Each is led by a partner with sector experience." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-12 rounded-xl border border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "lg:col-span-5 divide-y divide-border bg-[var(--color-background)]", children: SERVICES.map((s, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            onFocus: () => setActive(i),
            onClick: () => setActive(i),
            className: `group w-full flex items-center gap-4 px-6 py-5 text-left transition-colors ${isActive ? "bg-white" : "hover:bg-white/60"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `inline-flex h-10 w-10 items-center justify-center rounded-md transition-colors ${isActive ? "bg-[var(--color-accent)] text-white" : "bg-white text-[var(--color-navy-2)] border border-border"}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `block text-[15px] font-semibold ${isActive ? "text-[var(--color-accent)]" : "text-[var(--color-primary)]"}`, children: s.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs text-muted-foreground mt-0.5", children: s.summary.split(",")[0] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ChevronRight,
                {
                  className: `h-4 w-4 transition-transform ${isActive ? "translate-x-0.5 text-[var(--color-accent)]" : "text-muted-foreground"}`
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-7 p-8 lg:p-12 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-12 w-12 items-center justify-center rounded-md bg-[var(--color-navy)] text-white mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(A.icon, { className: "h-6 w-6" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold text-[var(--color-primary)]", children: A.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-[15px] text-muted-foreground leading-relaxed max-w-xl", children: A.summary }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid sm:grid-cols-2 gap-3 max-w-xl", children: A.points.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
...
function ProcessTimeline() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[var(--color-background)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-[0.18em] text-[var(--color-accent)] uppercase", children: "How we work" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-3xl sm:text-4xl font-semibold leading-tight", children: "A predictable, four-step engagement." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-[15px] text-muted-foreground leading-relaxed", children: "Same rhythm whether it's a single filing or a multi-entity audit. You always know where things stand." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block absolute left-0 right-0 top-7 h-px bg-border" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-8 md:grid-cols-4", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 14 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 inline-flex h-14 w-14 items-center justify-center rounded-full bg-white border border-border text-[var(--color-navy-2)] shadow-[0_4px_18px_oklch(0.2_0.04_260/0.06)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "h-5 w-5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-[var(--color-accent)] tracking-widest", children: [
                "0",
                i + 1
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 text-lg font-semibold text-[var(--color-primary)]", children: s.t }),
...
function WhyChooseUs() {
  const items = [
    ...
    { icon: Earth, t: "Cross-border ready", d: "Experience with FEMA, transfer pricing, and overseas group reporting." },
    { icon: HeartHandshake, t: "Long-term partners", d: "Most clients have been with us for over 7 years. We work for the relationship." }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-[0.18em] text-[var(--color-accent)] uppercase", children: "Why ABC & Associates" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 text-3xl sm:text-4xl font-semibold leading-tight", children: [
        "The values our clients",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "keep coming back for."
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-px bg-border rounded-xl overflow-hidden border border-border md:grid-cols-2 lg:grid-cols-3", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 12 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-10 w-10 items-center justify-center rounded-md border border-border text-[var(--color-navy-2)] group-hover:border-[var(--color-accent)] group-hover:text-[var(--color-accent)] transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(it.icon, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 text-base font-semibold text-[var(--color-primary)]", children: it.t }),
...
function TeamScroller() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[var(--color-background)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-[0.18em] text-[var(--color-accent)] uppercase", children: "The people" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-3xl sm:text-4xl font-semibold leading-tight", children: "A senior team, on every file." })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: TEAM.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.article,
          {
            initial: { opacity: 0, y: 14 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/3] w-full rounded-lg bg-gradient-to-br from-[var(--color-navy)] to-[var(--color-navy-2)] flex items-center justify-center text-white text-3xl font-semibold tracking-wide", children: m.initials }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 text-base font-semibold text-[var(--color-primary)]", children: m.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-[var(--color-accent)] mt-0.5", children: m.role }),
...
function ContactSplit() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-tight py-24 grid gap-12 lg:grid-cols-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-[0.18em] text-[var(--color-accent)] uppercase", children: "Get in touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-3xl sm:text-4xl font-semibold leading-tight", children: "Let's talk about your books." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-[15px] text-muted-foreground leading-relaxed max-w-md", children: "Tell us a bit about your business and what you need. A partner will respond within one business day." }),
      ...
      ].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-10 w-10 items-center justify-center rounded-md bg-[var(--color-navy)]/5 text-[var(--color-navy-2)] shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(i.icon, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: i.t }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-[var(--color-foreground)] mt-0.5", children: i.d })
        ] })
      ] }, i.t)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.form,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Full name", placeholder: "Jane Doe" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Company", placeholder: "Acme Pvt. Ltd." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Email", placeholder: "jane@acme.com", type: "email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Phone", placeholder: "+91 98765 43210" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-[var(--color-primary)] uppercase tracking-wider mb-2", children: "Service interest" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "w-full rounded-md border border-border bg-white px-3.5 py-2.5 text-sm text-[var(--color-foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)]/40 focus:border-[var(--color-accent)]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Audit & Assurance" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Direct Taxation" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "GST Advisory" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Corporate Compliance" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Business Advisory" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Outsourced Accounting" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-[var(--color-primary)] uppercase tracking-wider mb-2", children: "Message" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  rows: 4,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "We respond within 1 business day. Your details stay confidential." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "submit",
...
function Field({ label, placeholder, type = "text" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-[var(--color-primary)] uppercase tracking-wider mb-2", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type,
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(IntroBlock, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureStrip, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AboutStats, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ServicesSplit, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProcessTimeline, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WhyChooseUs, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TeamScroller, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ContactSplit, {})
    ] }),
