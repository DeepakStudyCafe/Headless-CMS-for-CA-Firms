...
async function main() {
  ...
  const website = await prisma.website.upsert({
    ...
    update: {
      ...
      domain: ' http://canpaassociates.com',
      logo: 'https://api.digitechai.in/uploads/logo.png',
      phone: '+91 9820362288',
      email: 'nipun.panchamiya@outlook.com',
      address: '420, Ajmera Sikova , off. LBS Road, Ghatkopar West, Mumbai 400 086',
      workingHours: 'Mon - Sat: 10 AM to 6.30 PM',
      isActive: true,
      isAdminEnabled: true,
      themeConfig: {
        primaryColor: '#0A0E17',
        ...
        footerContent: {
          ...
          copyright: `© ${new Date().getFullYear()} Nipun Panchamiya and Associates. All rights reserved.`,
          facebook: '',
          twitter: '',
          linkedin: '',
          instagram: '',
    ...
    create: {
      name: 'Nipun Panchamiya and Associates',
      slug: 'nipun-panchamiya-and-associates',
      domain: ' http://canpaassociates.com',
      logo: 'https://api.digitechai.in/uploads/logo.png',
  ...
  console.log('✅ nipun-panchamiya-and-associates website created')
  ...
  await prisma.page.create({
    data: {
      ...
      slug: 'home',
      title: 'Home - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'about',
      title: 'About Us - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            textContent: {
              ...
              subheading: 'Founded in 2005, Nipun Panchamiya and Associates has built a legacy of trust and excellence, serving 500+ businesses across India with meticulous financial expertise.',
              cta: 'Meet the Team',
            },
          },
          {
          ...
          },
          {
            ...
            textContent: {
              ...
              subheading: 'Discover how Nipun Panchamiya and Associates can become your most trusted financial partner.',
              cta: 'Schedule Free Consultation',
              secondaryCta: 'Call Us',
            },
          },
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'services',
      title: 'Services - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  for (const service of SERVICES) {
    ...
    await prisma.page.create({
      data: {
        ...
        title: `${service.title} - Nipun Panchamiya and Associates`,
        status: 'PUBLISHED',
        publishedAt: new Date(),
        sections: {
          create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'team',
      title: 'Our Team - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'gallery',
      title: 'Gallery - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            textContent: {
              label: 'Our World',
              heading: 'A Glimpse Into Nipun Panchamiya and Associates',
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'contact',
      title: 'Contact Us - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'query',
      title: 'Submit a Query - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'career',
      title: 'Careers - Nipun Panchamiya and Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            order: 2,
            textContent: {
              label: 'Life at Nipun Panchamiya and Associates',
