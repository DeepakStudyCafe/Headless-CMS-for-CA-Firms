...
async function main() {
  console.log('Seeding Template 1 (Sterling & Co.) website data...')

  const website = await prisma.website.upsert({
    where: { slug: 'template-1' },
    update: {
      name: 'Sterling & Co.',
      domain: 'https://template1.local',
      ...
      themeConfig: {
        ...
        footerContent: {
          ...
          copyright: "© 2026 Sterling & Co. Chartered Accountants. All rights reserved.",
          facebook: "",
          twitter: "",
          linkedin: "",
          instagram: "",
  ...
  console.log('✅ Sterling & Co. (Template 1) website created')
        ...
        create: [
          {
            ...
            textContent: {
              ...
              subheading: 'Sterling & Co. — trusted by 2,500+ businesses for taxation, compliance, and strategic financial advisory since 1995.',
          ...
          },
          {
            ...
            textContent: {
              heading: 'Nearly Three Decades of Financial Excellence',
              description: 'Founded in 1995, Sterling & Co. has grown from a small practice to one of India\'s most respected chartered accountancy firms. We combine deep expertise with innovative solutions to help businesses navigate complex financial landscapes.',
              stats: STATS,
            },
          },
          {
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'query',
      title: 'Submit a Query - Sterling & Co.',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  console.log('  ✅ Template 1: Pages created')

  // ─── Seed SiteAdmin credentials for /admin route ─────────────────────────────
  const bcrypt = await import('bcryptjs')
  const siteAdminEmail = 'admin@template1.local'
  ...
  console.log(`  ✅ Template 1: SiteAdmin credentials set — ${siteAdminEmail} / ${siteAdminPassword}`)

  console.log('\n🎉 Database seed for Template 1 completed successfully!')
}

main()
  .catch((e) => {
    console.error('Error seeding Template 1 data:', e)
    process.exit(1)
  })
  .finally(async () => {
