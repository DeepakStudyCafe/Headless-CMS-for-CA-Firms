...
export const Route = createFileRoute("/query")({
  head: () => ({
    meta: [
      { title: "Query & Support — ABC & Associates" },
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/public/forms/template-17`, {
        ...
        body: JSON.stringify({ type: 'QUERY', data })
      });
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-5">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input name="phone" type="tel" placeholder="+91 98765 43210" className="bg-surface" />
                      </div>
                      <div className="space-y-2">
            ...
            <div className="space-y-6 lg:col-span-2">
              {[
                ...
                { icon: Phone, title: "Direct Contact", desc: `Phone: ${websiteData?.phone || "+91 98765 43210"}\nEmail: ${websiteData?.email || "contact@abcassociates.in"}` },
