      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-start">
          <div className="mb-8 md:mb-0 col-span-2 md:col-span-1">
            <div className="flex items-center space-x-3 mb-4 shrink-0 overflow-hidden">
              ...
              <div className="flex flex-col">
                <h3 className="text-xl font-bold p-0 leading-tight">Krishan Garg and Co.</h3>
          ...
          <div className="md:col-span-1 col-span-2 md:col-span-1">
            ...
            <div className="flex items-center mt-4 space-x-3">
              ...
              <a href={fc.linkedin || 'https://in.linkedin.com/company/krishan-garg-co'} target="_blank" rel="noopener" aria-label="LinkedIn" className="rounded-full bg-white/6 hover:bg-blue-600 transition-colors w-10 h-10 flex items-center justify-center">
        ...
        <div className="border-t border-gray-800 mt-8 pt-2 text-gray-400 flex flex-col md:flex-row md:justify-between md:items-center gap-1">
          <div className="text-left">
            {fc.copyright || '\u00a9 2026 Krishan Garg and Co. All rights reserved.'}
          </div>
