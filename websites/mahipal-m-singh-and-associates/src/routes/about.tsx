...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn about Mahipal M Singh & Associates — a Chartered Accountant firm with two decades of experience in audit, tax and advisory." },
      { property: "og:title", content: "About Mahipal M Singh & Associates" },
