...
const WEBSITE_SLUG = 'k-s-anithasree-and-associates'
...
export async function submitContactForm(formData: {
  ...
  try {
    ...
    const res = await fetch(endpoint, {
      ...
      body: JSON.stringify({
        ...formData,
        website: 'k-s-anithasree-and-associates'
      }),
    })
...
export async function submitCareerForm(formData: FormData) {
  try {
    ...
    formData.append('website', 'k-s-anithasree-and-associates')
...
// â”€â”€â”€ StudyCafe "What's New" post helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
