    ...
    <footer className="bg-secondary text-secondary-foreground mt-0.5">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-1 mb-2">
              <img
                ...
                alt="Ketki Dagha and Associates."
                className="w-14 h-14 object-contain p-1 rounded-md bg-transparent mb-2"
              />
              <div>
                <span className="font-heading font-bold text-lg block leading-none">Ketki Dagha and Associates.</span>
                <span className="text-xs uppercase tracking-[0.1em] opacity-60">Chartered Accountants</span>
              </div>
            </div>
      ...
      <div className="border-t border-secondary-foreground/8">
        <div className="container py-6 flex flex-col sm:flex-row items-center justify-between text-xs text-secondary-foreground/40">
          ...
          <div>
            Powered By{' '}
            <a href="https://webcafe.co.in/" target="_blank" rel="noopener" className="hover:text-accent hover:underline no-underline">Webcafe a Product of Studycafe Pvt Ltd.</a>
          </div>
        </div>
      </div>
    </footer>
