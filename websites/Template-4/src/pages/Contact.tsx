...
const Contact = () => (
  <Layout>
    <PageHero title="Contact Us" subtitle="Let's start a conversation about your financial future" breadcrumbs={[{ label: "Home", href: "/" }, { label: "Contact" }]} image={contactHero} />

    <section className="py-24 bg-background">
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16">
          <ScrollReveal>
            <span className="text-accent font-semibold text-xs uppercase tracking-[0.2em]">Reach Out</span>
          ...
          <ScrollReveal delay={0.2}>
            <div className="space-y-6">
              ...
              {[
                { icon: MapPin, title: "Address", text: "123 Financial District, BKC, Mumbai, Maharashtra 400051, India" },
                { icon: Phone, title: "Phone", text: "+91 22 1234 5678" },
                { icon: Mail, title: "Email", text: "info@sharmaco.com" },
