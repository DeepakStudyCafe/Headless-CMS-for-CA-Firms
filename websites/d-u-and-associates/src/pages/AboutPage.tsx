...
const AboutPage = () => {
  ...
  return (
    <div>
      <PageHero title="About D U & Associates" breadcrumb="About" image={pageData?.sections?.find((s: any) => s.type === 'hero')?.imageUrl || getImageUrl('/uploads/about-hero.jpg')} />
  ...
  D U & Associates is a trusted FEMA & Indirect Tax Expert firm with a legacy of excellence spanning nearly two decades. We blend deep regulatory expertise with modern strategies to deliver reliable and result-driven financial solutions.
</p>
