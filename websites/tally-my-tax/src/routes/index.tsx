...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Tally My Tax — Chartered Accountants | Tax, Audit & Advisory" },
      {
        name: "description",
        content:
          "Tally My Tax is a trusted Chartered Accountancy firm offering tax planning, GST, audit, company registration, and business consulting across India.",
      },
      { property: "og:title", content: "Tally My Tax — Chartered Accountants" },
      {
