...
async function main() {
  ...
  await prisma.section.deleteMany({ where: { page: { website: { slug: 'krishan-garg-and-co' } } } });
  await prisma.page.deleteMany({ where: { website: { slug: 'krishan-garg-and-co' } } });
  ...
  // ============================================================
  // WEBSITE 1: Krishan Garg and Co (Professional Blue Theme)
  // ============================================================
  const vbagrawal = await prisma.website.upsert({
    where: { slug: 'krishan-garg-and-co' },
    update: {
      name: 'Krishan Garg and Co',
      domain: 'https://kgca.in/',
      logo: '/uploads/logo.svg',
      phone: '+91 9977333300',
      email: 'hello@kgca.in',
      address: '409-411 Chetak Centre, 12/2 RNT Marg, Indore MP 452001.',
  ...
  console.log('✅ Krishan Garg and Co website created')
  ...
  await prisma.page.create({
    data: {
      ...
      slug: 'home',
      title: 'Home - Krishan Garg and Co',
      status: 'PUBLISHED',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'With over 1 years of experience, Krishan Garg and Co provides top-tier audit, taxation, and corporate advisory services to businesses across industries.',
  ...
  await prisma.page.create({
    data: {
      websiteId: vbagrawal.id,
      slug: 'about',
      title: 'About Us - Krishan Garg and Co',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            textContent: {
              heading: 'About Krishan Garg and Co',
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'Founded by CA Krishan Garg, our firm has grown from a small practice to one of the most respected accounting firms in the region. We specialize in serving corporate clients with complex audit and taxation needs.',
  ...
  await prisma.page.create({
    data: {
      websiteId: vbagrawal.id,
      slug: 'team',
      title: 'Our Team - Krishan Garg and Co',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                { name: 'CA Krishan Garg', role: 'Managing Partner', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400', description: 'FCA, 30+ years experience' },
  ...
  await prisma.page.create({
    data: {
      websiteId: vbagrawal.id,
      slug: 'services',
      title: 'Our Services - Krishan Garg and Co',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: vbagrawal.id,
      slug: 'gallery',
      title: 'Gallery - Krishan Garg and Co',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: vbagrawal.id,
      slug: 'contact',
      title: 'Contact Us - Krishan Garg and Co',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  const vbagrawalServices = [
    {
      slug: 'audit-services',
      title: 'Audit Services - Krishan Garg and Co',
    ...
    },
    {
      ...
      title: 'Taxation Services - Krishan Garg and Co',
    ...
    },
    {
      ...
      title: 'Corporate Services - Krishan Garg and Co',
    ...
    {
      slug: 'bookkeeping',
      title: 'Bookkeeping Services - Krishan Garg and Co',
    ...
    {
      slug: 'gst-filing',
      title: 'GST Filing Services - Krishan Garg and Co',
    ...
    {
      slug: 'payroll',
      title: 'Payroll Management - Krishan Garg and Co',
    ...
    {
      slug: 'tax-planning',
      title: 'Tax Planning & Advisory - Krishan Garg and Co',
    ...
    },
    {
      ...
      title: 'Company Formation - Krishan Garg and Co',
    ...
    {
      slug: 'compliance',
      title: 'Regulatory Compliance - Krishan Garg and Co',
    ...
    },
    {
      ...
      title: 'Financial Advisory - Krishan Garg and Co',
  ...
  console.log('  ✅ Krishan Garg and Co: 10 pages created')
