...
export function TopHeader() {
  ...
  if (!websiteData) {
    return (
      <div className="bg-gradient-to-r from-gray-600 to-amber-900 text-white py-2">
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row sm:justify-between items-center text-sm">
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4" />
                <span>+91 8693075895</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4" />
                <span>yadawarm1@gmail.com</span>
              </div>
            </div>
            <div className="flex items-center space-x-2 mt-2 sm:mt-0">
              <Clock className="w-4 h-4" />
              <span>11:00 AM - 7:00 PM Monday - Saturday</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center space-x-2 mt-2 sm:mt-0">
            ...
            <span>
              {websiteData.workingHours
                ...
                : "11:00 AM - 07:00 PM Monday - Saturday"}
            </span>
          </div>
        </div>
      </div>
