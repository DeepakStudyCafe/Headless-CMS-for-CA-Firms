      ...
      <section className="py-20 px-6 lg:px-12">
        <div className="max-w-3xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            className="rounded-2xl border p-8 md:p-10" style={{ background: "#111111", borderColor: "rgba(224,140,46,0.12)" }}>
            <h2 className="font-heading font-bold text-2xl mb-2" style={{ color: "#F5F0E8" }}>
              {formSection?.textContent?.formHeading}
            </h2>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <FormField control={form.control} name="queryType" render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs font-mono uppercase tracking-wider" style={{ color: "rgba(245,240,232,0.4)" }}>Query Type</FormLabel>
                ...
                <FormField control={form.control} name="serviceType" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-mono uppercase tracking-wider" style={{ color: "rgba(245,240,232,0.4)" }}>Service of Interest</FormLabel>
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                ...
                <FormField control={form.control} name="message" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-mono uppercase tracking-wider" style={{ color: "rgba(245,240,232,0.4)" }}>Your Query</FormLabel>
                    <FormControl>
