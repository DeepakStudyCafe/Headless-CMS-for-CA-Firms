...
/** Domains considered "monitored" â€” links pointing here get rewritten to /post/<slug> */
...
function extractSlug(url: URL): string | null {
  ...
  // Strip trailing numeric suffix e.g. my-post-12345 â†’ my-post
...
/**
 * Rewrite monitored-site anchors to internal /post/<slug> routes,
 * then sanitize the HTML with a permissive allow-list.
 */
