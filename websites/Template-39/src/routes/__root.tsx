  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/" className="inline-flex items-center justify-center rounded-full gradient-pink px-5 py-2.5 text-sm font-semibold text-white">
            Go home
          </Link>
        </div>
      </div>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premier Chartered Accountant firm in India." },
    ],
    links: [
