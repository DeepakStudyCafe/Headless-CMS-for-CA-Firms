            ...
            >
              ...
              <div className="relative z-10 text-center max-w-4xl px-4">
                <motion.h1
                  ...
                  className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-[#78350f]"
                >
                ...
                <motion.p
                  ...
                  className="text-lg md:text-xl mb-8 leading-relaxed text-[#78350f]/90"
                >
          ...
          return (
            <section key={section.id} className="py-16 md:py-20 bg-white text-gray-900">
              <div className="container mx-auto px-4 text-center">
                ...
                >
                  <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#78350f]">
                    {section.textContent?.heading}
                  </h2>
                  <p className="text-lg md:text-xl mb-8 text-[#78350f]/80">
                    {section.textContent?.description}
                  </p>
                  {section.textContent?.cta && (
                    <motion.button
