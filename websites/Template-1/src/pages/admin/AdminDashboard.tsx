          ...
          <div className="rounded-xl border p-6 space-y-6" style={{ background: "#111111", borderColor: "rgba(224,140,46,0.15)" }}>
            ...
            {!siteSettings.isAdminEnabled && (
              <div className="rounded-lg p-3 text-xs" style={{ background: "rgba(234,179,8,0.1)", border: "1px solid rgba(234,179,8,0.25)", color: "rgba(234,179,8,0.8)" }}>
                <strong>Warning:</strong> Disabling the admin route will lock you out of this panel. Make sure you re-enable it from the main admin dashboard before logging out.
              </div>
            )}
            <button type="button" onClick={handleSettingsSave} disabled={settingsSaving} className="flex items-center gap-2 text-sm px-5 py-2.5 rounded-lg disabled:opacity-50 transition-all" style={{ background: "#E08C2E", color: "#0D0D0D", fontWeight: 600 }}>
