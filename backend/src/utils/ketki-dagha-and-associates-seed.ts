...
async function main() {
  console.log('🌱 Starting Ketki Dagha and Associates. database seed...')

  // Create Ketki Dagha and Associates. Website
  const ketkiWebsite = await prisma.website.upsert({
    ...
    update: {
      ...
      themeConfig: {
        ...
        theme: 'modern',
        footerContent: {
          description: 'A trusted Chartered Accountancy firm delivering excellence in audit, tax, and advisory services.',
          copyright: '© 2026 Ketki Dagha and Associates.. All rights reserved.'
        }
      },
    },
    create: {
  ...
  console.log('✅ Ketki Dagha and Associates. website created')

  // Helper to safely delete existing old pages to re-seed fresh
  await prisma.section.deleteMany({
    where: { page: { websiteId: ketkiWebsite.id } }
  })
  await prisma.page.deleteMany({
    where: { websiteId: ketkiWebsite.id }
  })

  // Home Page
  await prisma.page.create({
    data: {
      websiteId: ketkiWebsite.id,
      slug: 'home',
      title: 'Home',
      status: 'PUBLISHED',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description1: 'Ketki Dagha and Associates. is a premier Chartered Accountancy firm committed to delivering exceptional financial services. With nearly two decades of experience, we serve a diverse clientele from ambitious startups to established corporations.',
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                { name: 'Rajesh Kumar', role: 'CEO, TechStartup India', text: 'Ketki Dagha and Associates. transformed our financial operations. Their expertise in tax planning saved us significantly and their team\'s responsiveness is unmatched.' },
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description1: 'Ketki Dagha and Associates. is one of India\'s leading Chartered Accountancy firms, established in 2005. We provide comprehensive financial services including auditing, taxation, advisory, and compliance solutions.',
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                { year: '2005', title: 'Founded', desc: 'Ketki Dagha and Associates. established with a vision to redefine financial advisory.' },
          ...
          },
          {
            ...
            textContent: {
              badge: 'Why Choose Us',
              heading: 'The Ketki Dagha and Associates. Advantage',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'At Ketki Dagha and Associates., we foster a culture of continuous learning, collaboration, and professional development. Our team members are empowered to innovate and excel in their careers.',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'At Ketki Dagha and Associates., we nurture talent and provide an environment where professionals can thrive, learn, and grow into industry leaders.'
            }
          },
          {
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              officeAddress: '226, Avior Corporate Park, M M Malviya Road, Mulund West, Mumbai 400080',
              officePhone: '+91 9012490624',
              officeEmail: 'ketkidaghaandassociates@gmail.com',
              officeHours: 'Mon - Sat: 10:00 AM - 6:00 PM',
              mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3768.531937864672!2d72.94171667499258!3d19.171955282052497!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b949e2655d67%3A0xe2a2d4a298ca1342!2sKetki%20Dagha%20And%20Associates!5e0!3m2!1sen!2sin!4v1783677723885!5m2!1sen!2sin"
            }
          },
          {
            type: 'contact-cta',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              quickContacts: [
                { icon: 'Phone', label: '+91 9012490624', sub: 'Mon-Sat, 10am-6pm' },
                { icon: 'Mail', label: 'ketkidaghaandassociates@gmail.com', sub: 'We reply within 24 hours' },
  ...
  console.log('✅ Ketki Dagha and Associates. seed complete')
}
