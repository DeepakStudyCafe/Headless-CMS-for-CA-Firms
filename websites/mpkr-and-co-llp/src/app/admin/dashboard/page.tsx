            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input type="text" autoComplete="off" value={footerForm.workingHours} onChange={(e) => setFooterForm((f) => ({ ...f, workingHours: e.target.value }))} placeholder="11:00 to 20:00" className={inp} />
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
            ...
            <div className="space-y-3 pb-5 border-b border-gray-100">
              ...
              <div>
                ...
                <input type="text" autoComplete="off" value={contactForm.heroTitle} onChange={(e) => setContactForm((f) => ({ ...f, heroTitle: e.target.value }))} placeholder="e.g. Contact MPKR & Co LLP" className={inp} />
              </div>
              <div>
            ...
            <div className="space-y-3 pb-5 border-b border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="sm:col-span-2">
                  <label className={lbl}>Working Hours</label>
                  <input type="text" autoComplete="off" value={contactForm.workingHours} onChange={(e) => setContactForm((f) => ({ ...f, workingHours: e.target.value }))} placeholder="11:00 to 20:00" className={inp} />
                </div>
              </div>
            </div>
