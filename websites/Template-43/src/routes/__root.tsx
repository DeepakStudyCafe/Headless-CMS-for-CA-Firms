...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A boutique chartered accountancy firm delivering precision tax, audit, advisory and compliance services to ambitious businesses." },
