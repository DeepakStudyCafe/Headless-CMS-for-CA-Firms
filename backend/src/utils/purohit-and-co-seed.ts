...
async function main() {
  ...
  await prisma.section.deleteMany({ where: { page: { website: { slug: 'purohit-and-co' } } } });
  await prisma.page.deleteMany({ where: { website: { slug: 'purohit-and-co' } } });

  // Create admin user
  const adminPassword = await bcrypt.hash('purohitAdmin@123', 10)
  const admin = await prisma.user.upsert({
    where: { email: 'admin@cafirm.com' },
    update: {},
    create: {
      name: 'Admin User',
      email: 'purohitadmin@cafirm.com',
  ...
  // ============================================================
  // WEBSITE 1: Purohit & Co.
  // ============================================================
  const purohit = await prisma.website.upsert({
    where: { slug: 'purohit-and-co' },
    update: {
      name: 'Purohit & Co.',
      domain: 'https://purohitco.com/',
      logo: '/uploads/logo.svg',
      phone: '+91 9998902046, +91 7405859821',
      email: 'accounts@purohitco.com, capurohitandco@gmail.com',
      address: 'A-522, Siddhivinayak Towers, near Kataria Arcade, Off SG highway, makarba, Ahmedabad 380051.',
  ...
  console.log('✅ Purohit & Co. website created')

  // purohit Pages
  await prisma.page.create({
    data: {
      websiteId: purohit.id,
      slug: 'home',
      title: 'Home - Purohit & Co.',
      status: 'PUBLISHED',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'Purohit & Co. provides top-tier audit, taxation, and corporate advisory services to businesses across industries.',
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'Management', description: 'Internal controls and risk assessment' },
        ...
        create: [
          {
            ...
            textContent: {
              heading: 'About Purohit & Co.',
              subheading: 'Building trust through excellence in accounting',
            },
          },
          {
            type: 'text-image',
            ...
            textContent: {
              ...
              description: 'Founded by CA Purohit, our firm has grown from a small practice to one of the most respected accounting firms in the region. We specialize in serving corporate clients with complex audit and taxation needs.',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                { name: 'CA Purohit', role: 'Managing Partner', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400', description: 'FCA' },
              ],
            },
          },
        ],
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'Management', description: 'Internal controls and fraud detection' },
  ...
  // purohit Service Pages
  const purohitServices = [
    {
      slug: 'audit-services',
      title: 'Audit Services - Purohit & Co.',
    ...
    },
    {
      ...
      title: 'Taxation Services - Purohit & Co.',
    ...
    },
    {
      ...
      title: 'Corporate Services - Purohit & Co.',
    ...
    {
      slug: 'bookkeeping',
      title: 'Bookkeeping Services - Purohit & Co.',
    ...
    {
      slug: 'gst-filing',
      title: 'GST Filing Services - Purohit & Co.',
    ...
    {
      slug: 'payroll',
      title: 'Payroll Management - Purohit & Co.',
    ...
    {
      slug: 'tax-planning',
      title: 'Tax Planning & Advisory - Purohit & Co.',
    ...
    },
    {
      ...
      title: 'Company Formation - Purohit & Co.',
    ...
    {
      slug: 'compliance',
      title: 'Regulatory Compliance - Purohit & Co.',
    ...
    },
    {
      ...
      title: 'Financial Advisory - Purohit & Co.',
  ...
  for (const service of purohitServices) {
    await prisma.page.create({
      data: {
        websiteId: purohit.id,
        slug: service.slug,
  ...
  console.log('  ✅ Purohit & Co.: 10 pages created')
