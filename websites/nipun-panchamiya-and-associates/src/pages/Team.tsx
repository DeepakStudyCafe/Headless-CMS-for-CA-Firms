  ...
  return (
    <div className="bg-ink min-h-screen font-body text-cream">
      ...
      <section className="relative min-h-[400px] flex items-end bg-ink overflow-hidden pt-20">
        {hero.image && (
          <>
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('${getImageUrl(hero.image)}')`, opacity: 0.2 }} />
              ...
              <FadeIn key={i} delay={i * 0.07}>
                <div className="rounded-lg overflow-hidden bg-ink border border-gold/15 hover:border-gold/40 transition-all hover:-translate-y-1 group">
                  <div className="relative overflow-hidden" style={{ paddingBottom: "100%" }}>
                    <img
                      src={getImageUrl(member.image || member.photo) || `https://ui-avatars.com/api/?name=${encodeURIComponent(member.name || "Team")}&background=1a1a2e&color=C8A96E&size=400`}
                      alt={member.name}
