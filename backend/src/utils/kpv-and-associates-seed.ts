...
async function main() {
  ...
  await prisma.section.deleteMany({ where: { page: { website: { slug: 'kpv-and-associates' } } } });
  await prisma.page.deleteMany({ where: { website: { slug: 'kpv-and-associates' } } });
  ...
  // ============================================================
  // WEBSITE 1: KPV And associates (Professional Blue Theme)
  // ============================================================
  const kpv = await prisma.website.upsert({
    where: { slug: 'kpv-and-associates' },
    update: {
      name: 'KPV And associates',
      domain: 'https://kpvandassociates.com/',
      logo: '/uploads/logo.svg',
      phone: '+91 7899257321, +91 8892357321',
      email: 'pvinodkumara@gmail.com',
      address: 'No 9/2 Sri Skanda Arcade Opp: sunshine Hospital Hennur Bagalur main Road Kothanur Bangalore - 560077.',
      workingHours: '9:00 to 6:00 Mon Day to Saturday',
      themeConfig: {
        primaryColor: '#1e40af',
  ...
  console.log('✅ KPV And associates website created')
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'With over 1 years of experience, KPV And associates provides top-tier audit, taxation, and corporate advisory services to businesses across industries.',
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'kpv Management', description: 'Internal controls and rkpv assessment' },
  ...
  await prisma.page.create({
    data: {
      websiteId: kpv.id,
      slug: 'about',
      title: 'About Us - KPV And associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          {
            ...
            textContent: {
              heading: 'About KPV And associates',
          ...
          },
          {
            ...
            textContent: {
              ...
              description: 'Founded by Vinod Kumara, our firm has grown from a small practice to one of the most respected accounting firms in the region. We specialize in serving corporate clients with complex audit and taxation needs.',
  ...
  await prisma.page.create({
    data: {
      websiteId: kpv.id,
      slug: 'team',
      title: 'Our Team - KPV And associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                { name: 'Vinod Kumara', role: 'Managing Partner', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400', description: 'FCA, 30+ years experience' },
  ...
  await prisma.page.create({
    data: {
      websiteId: kpv.id,
      slug: 'services',
      title: 'Our Services - KPV And associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'users', title: 'kpv Management', description: 'Internal controls and fraud detection' },
  ...
  await prisma.page.create({
    data: {
      websiteId: kpv.id,
      slug: 'gallery',
      title: 'Gallery - KPV And associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: kpv.id,
      slug: 'contact',
      title: 'Contact Us - KPV And associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              phone: '+91 7899257321, +91 8892357321',
              email: 'pvinodkumara@gmail.com',
              hours: '9:00 to 6:00 Mon Day to Saturday',
              mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.620138508767!2d77.6489474!3d13.0598342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1755f15cf0d1%3A0x3aef0f949ed720f4!2sKPV%20%26%20Associates!5e0!3m2!1sen!2sin!4v1780722964001!5m2!1sen!2sin',
            },
          },
          {
            type: 'contact-form',
  ...
  const kpvServices = [
    {
      slug: 'audit-services',
      title: 'Audit Services - KPV And associates',
    ...
    },
    {
      ...
      title: 'Taxation Services - KPV And associates',
    ...
    },
    {
      ...
      title: 'Corporate Services - KPV And associates',
    ...
    {
      slug: 'bookkeeping',
      title: 'Bookkeeping Services - KPV And associates',
    ...
    {
      slug: 'gst-filing',
      title: 'GST Filing Services - KPV And associates',
    ...
    {
      slug: 'payroll',
      title: 'Payroll Management - KPV And associates',
    ...
    {
      slug: 'tax-planning',
      title: 'Tax Planning & Advisory - KPV And associates',
    ...
    },
    {
      ...
      title: 'Company Formation - KPV And associates',
    ...
    {
      slug: 'compliance',
      title: 'Regulatory Compliance - KPV And associates',
    ...
    },
    {
      ...
      title: 'Financial Advisory - KPV And associates',
  ...
  for (const service of kpvServices) {
    await prisma.page.create({
      data: {
        websiteId: kpv.id,
        slug: service.slug,
  ...
  console.log('  ✅ KPV And associates: 10 pages created')
