...
async function main() {
  console.log('Seeding Template 6 (abc & Associates) website data...')

  const template6 = await prisma.website.upsert({
    where: { slug: 'template-6' },
    update: {
      name: 'abc & Associates',
      domain: 'https://digitechca.in',
  ...
  console.log('✅ abc & Associates (Template 6) website created')
        ...
        create: [
          {
            ...
            textContent: {
              ...
              subheading: 'abc & Associates — trusted by 500+ businesses for taxation, compliance, and strategic financial advisory.',
        ...
        create: [
          ...
          },
          {
            ...
            textContent: {
              ...
              heading: 'Our Story',
              paragraphs: [
                'abc & Associates was founded in 2006 with a clear mission: to provide transparent, reliable, and world-class financial services to businesses across India. What started as a small practice has grown into a full-service chartered accountancy firm trusted by over 500 clients.',
  ...
  await prisma.page.create({
    data: {
      websiteId: template6.id,
      slug: 'team',
      title: 'Meet Our Experts - abc & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  console.log('  ✅ Template 6: Pages created')

  // ─── Seed SiteAdmin credentials for /admin route ─────────────────────────────
  const bcrypt = await import('bcryptjs')
  const siteAdminEmail = 'admin@digitechca.in'
  ...
  console.log(`  ✅ Template 6: SiteAdmin credentials set — ${siteAdminEmail} / ${siteAdminPassword}`)

  console.log('\n🎉 Database seed for Template 6 completed successfully!')

}

main()
  .catch((e) => {
    console.error('Error seeding template 6 data:', e)
    process.exit(1)
  })
  .finally(async () => {
