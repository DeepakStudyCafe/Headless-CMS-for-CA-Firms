...
async function main() {
  console.log('Seeding Rupesh-Gunjal website data...')

  const website = await prisma.website.upsert({
    where: { slug: 'Rupesh-Gunjal' },
    update: {
      name: 'Rupesh Gunjal & Associates',
      domain: 'https://cagunjal.in',
      logo: 'https://api.digitechai.in/uploads/logo.png',
      phone: '9987641644, 9082847408',
      email: 'carupeshgunjal@gmail.com',
      address: 'Office no 469, Central facility Building-II, APMC Market-II, Sector-19, Vashi, Navi Mumbai-400703',
      ...
      themeConfig: {
        ...
        contactContent: {
          ...
          mapUrl: 'https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3770.6631686654!2d73.00389917466524!3d19.0785415518938!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTnCsDA0JzQyLjciTiA3M8KwMDAnMjMuMyJF!5e0!3m2!1sen!2sin!4v1779452286411!5m2!1sen!2sin',
        },
        footerContent: {
          description: "Delivering reliable financial, taxation, and advisory solutions with a client-focused approach, helping businesses and individuals navigate complex financial decisions with clarity, confidence, and long-term growth..",
          copyright: "© 2026 Rupesh Gunjal & Associates. All rights reserved.",
          facebook: "",
          twitter: "",
          linkedin: "https://linkedin.com/in/ca-rupesh-gunjal-ab2b7766",
          instagram: "",
          youtube: "",
        }
      },
  ...
  console.log('✅ Rupesh-Gunjal website created')
  ...
  await prisma.page.create({
    data: {
      ...
      slug: 'home',
      title: 'Home - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
        ...
        create: [
          {
            ...
            textContent: {
              ...
              description: 'Rupesh Gunjal & Associates — premium chartered accountancy services. Audit, tax, advisory and compliance with elegance and precision.',
          ...
          },
          {
            ...
            textContent: {
              ...
              items: [
                ...
                { icon: 'Users', title: 'Payroll', desc: 'Comprehensive payroll management solutions.', featured: false },
                { icon: 'Building2', title: 'Company Formation', desc: 'End-to-end business registration services.', featured: false },
                { icon: 'Shield', title: 'Compliance', desc: 'Regulatory and statutory compliance advisory.', featured: false }
              ]
            },
          },
          {
          ...
          },
          {
            ...
            textContent: {
              ...
              contacts: [
                { icon: 'Phone', label: 'Call Us', value: '9987641644, 9082847408' },
                { icon: 'Mail', label: 'Email Us', value: 'carupeshgunjal@gmail.com' },
                { icon: 'MapPin', label: 'Visit Us', value: 'Office no 469, Central facility Building-II, APMC Market-II, Sector-19, Vashi, Navi Mumbai-400703' }
              ]
            },
          }
        ]
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'about',
      title: 'About - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'services',
      title: 'Services - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  for (const svc of svcList) {
    await prisma.page.create({
      data: {
        websiteId: website.id,
        slug: svc.slug,
        title: `${svc.title} - Rupesh Gunjal & Associates`,
        status: 'PUBLISHED',
        publishedAt: new Date(),
        sections: {
          create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'team',
      title: 'Team - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'contact',
      title: 'Contact - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'gallery',
      title: 'Gallery - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'career',
      title: 'Careers - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  await prisma.page.create({
    data: {
      websiteId: website.id,
      slug: 'query',
      title: 'Submit a Query - Rupesh Gunjal & Associates',
      status: 'PUBLISHED',
      publishedAt: new Date(),
      sections: {
        create: [
  ...
  console.log('  ✅ Rupesh-Gunjal: Pages created')

  // Seed SiteAdmin credentials
  const bcrypt = await import('bcryptjs')
  const siteAdminEmail = 'admin@Rupesh-Gunjal.in'
  ...
  console.log(`  ✅ Rupesh-Gunjal: SiteAdmin credentials set`)

  console.log('\n🎉 Database seed for Rupesh-Gunjal completed successfully!')
}

main()
  .catch((e) => {
    console.error('Error seeding Rupesh-Gunjal data:', e)
    process.exit(1)
  })
  .finally(async () => {
