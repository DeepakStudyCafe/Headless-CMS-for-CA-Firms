  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 font-sans">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Website Temporarily Unavailable</h1>
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 text-left">
          <p className="text-xs font-semibold text-red-700 uppercase tracking-wide mb-1">Service Notice</p>
        ...
        <p className="mt-8 text-xs text-gray-400">
          Error code: SITE_OFFLINE &nbsp;&bull;&nbsp; Vanguard &amp; Co.
        </p>
      </div>
    </div>
  );
